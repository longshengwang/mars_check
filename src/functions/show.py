...
class ShowResource:
    ...
    def show_online_devices(self):
        print_normal('Show the ' + UseStyle('ONLINE', fore='green') + ' devices.')
    ...
    def show_snap_devices(self, snap_time):
        ...
        print_normal('Show the ' + UseStyle(snap_time, fore='green') + ' devices.')
    ...
    def show_online_links(self):
        print_normal('Show the ' + UseStyle('ONLINE', fore='green') + ' links.')
    ...
    def show_snap_links(self, snap_time_str):
        ...
        print_normal('Show the ' + UseStyle(snap_time_str, fore='green') + ' links.')
    ...
    def show_online_hosts(self):
        print_normal('Show the ' + UseStyle('ONLINE', fore='green') + ' hosts.')
    ...
    def show_snap_hosts(self, snap_time_str):
        print_normal('Show the ' + UseStyle(snap_time_str, fore='green') + ' hosts.')
